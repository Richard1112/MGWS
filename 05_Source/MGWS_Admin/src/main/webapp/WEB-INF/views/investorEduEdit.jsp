...
<body>
	<form:form id="mainForm" name="mainForm"
		action="${basePath}/investorEduEdit" method="post"
		commandName="tInvestorEdu" modelAttribute="tInvestorEdu">
			...
			<table class="editTable">
				<tr>
					<td colspan="2" align="left"><a href="javascript:void(0)"
						...
						href="${pageContext.request.contextPath}/investorEduInit"
...
<myfooter>
	...
	var saveImgUrl = "${saveInvestorEduPDFUrl}";
	var InvestorEduNo = $("#no").val();
	if ($("#fileName").val() != null && $("#fileName").val() != "") {
		...
		var tjson = {caption: '', // 展示的文件名  
                width: '120px',   
                url: '${basePath}/investorEduDeleteFile', // 删除url  
                key: $("#fileName").val(), // 删除是Ajax向后台传递的参数  
                extra: {fileId: $("#fileName").val(), InvestorEduNo: InvestorEduNo} 
            };
		preThumbConfigList.push(tjson);
	}
	$("#fileNameUpdate").fileinput({
        uploadUrl: '${pageContext.request.contextPath}/investorEduUpdateFile?InvestorEduNo='+InvestorEduNo,
