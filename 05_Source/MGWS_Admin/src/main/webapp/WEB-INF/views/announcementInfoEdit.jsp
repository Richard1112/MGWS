...
<body>
	<form:form id="mainForm" name="mainForm"
		action="${basePath}/announcementInfoEdit" method="post"
		commandName="tAnnouncementInfo" modelAttribute="tAnnouncementInfo">
			...
			<table class="editTable">
				<tr>
					<td colspan="2" align="left"><a href="javascript:void(0)"
						...
						href="${pageContext.request.contextPath}/announcementInfoInit"
...
<myfooter>
	...
	var saveImgUrl = "${saveAnnouncementInfoPDFUrl}";
	var announcementInfoNo = $("#no").val();
	if ($("#fileName").val() != null && $("#fileName").val() != "") {
		...
		var tjson = {caption: '', // 展示的文件名  
                width: '120px',   
                url: '${basePath}/announcementInfoDeleteFile', // 删除url  
                key: $("#fileName").val(), // 删除是Ajax向后台传递的参数  
                extra: {fileId: $("#fileName").val(), announcementInfoNo: announcementInfoNo} 
            };
		preThumbConfigList.push(tjson);
	}
	$("#fileNameUpdate").fileinput({
        uploadUrl: '${pageContext.request.contextPath}/announcementInfoUpdateFile?announcementInfoNo='+announcementInfoNo,
