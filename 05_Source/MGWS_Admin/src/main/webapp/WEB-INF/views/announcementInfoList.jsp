	...
	<form action="#" method="get" class="sidebar-form"
		...
		<div class="input-group" style="margin: 0px 25px;padding-top:15px; width: 95%;">
			<table class="search_table">
				<tr>
					<td align="right">
					<a href="${basePath}/announcementInfoAddInit" class="btn btn-info" title="信息公示-新增">新增</a>
					</td>
				</tr>
			</table>
			</span>
			...
			jQuery("#table").jqGrid(
					{
						...
						sortable:true,
						sortorder : "desc",
						editurl : "${basePath}/announcementInfoEdit",
						//后台返回数据
						...
						gridComplete:function(){
							...
							for (var i=0;i<ids.length;i++){
								...
								modify = "<a href='${basePath}/announcementInfo/"+model.no+"' style='color:#f60'>修改</a>";
		...
		function Delete(no){
			if(confirm("确定删除吗？")){
				jQuery.ajax({
					...
					url : '${pageContext.request.contextPath}/announcementInfoDelete?no='+no,
					cache : false,
					async : false,
					dataType : 'json',
