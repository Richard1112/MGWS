...
<body>
	<form action="#" method="get" class="sidebar-form"
		...
		<div class="input-group" style="margin: 0px 25px;padding-top:15px; width: 95%;">
			<table class="search_table">
				<tr>
					<td align="right">
					<a href="${basePath}/investorSignAddInit" class="btn btn-info" title="投资人签署-新增">新增</a>
					</td>
				</tr>
			</table>
			</span>
	...
	<script type="text/javascript">
		...
		function pageInit() {
			jQuery("#table").jqGrid(
					{
						url : '${basePath}/investorSign',
						method: "GET",
						datatype : "json",
						colNames : ['', '投资人签署标题', '发布时间', '开放标识',"",""],
						colModel : [ {
							name : 'no',
							index : 'no',
							hidden : true,
						...
						sortable:true,
						sortorder : "desc",
						editurl : "${basePath}/investorSignEdit",
						//后台返回数据
						...
						gridComplete:function(){
							...
							for (var i=0;i<ids.length;i++){
								...
								modify = "<a href='${basePath}/investorSign/"+model.no+"' style='color:#f60'>修改</a>";
		...
		function Delete(no){
			if(confirm("确定删除吗？")){
				jQuery.ajax({
					...
					url : '${pageContext.request.contextPath}/investorSignDelete?no='+no,
					cache : false,
					async : false,
					dataType : 'json',
