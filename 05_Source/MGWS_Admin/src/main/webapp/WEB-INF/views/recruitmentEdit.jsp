...
<body>
	<form action="${basePath}/recruitment" method="post" name="mainForm" class="sidebar-form"
		style="border: none;">
			...
			<table class="editTable">
				...
				<tr>
					...
					<td class="_cont"><input type="text" name="recruitJobTitle"
						...
						placeholder="招聘职位" id="recruitJobTitle"></td>
				</tr>
				<tr>
					<td class="_label">招聘人数</td>
					<td class="_cont"><input type="number" name="recruitNumber"
						class="form-control" style="background: #F7F8F9;"
						placeholder="招聘人数" id="recruitNumber"></td>
				</tr>
				<tr>
					<td class="_label">招聘地点</td>
					<td class="_cont"><input type="text" name="recruitLocale"
						class="form-control" style="background: #F7F8F9;"
						placeholder="招聘地点" id="recruitLocale"></td>
				</tr>
				<tr>
					<td class="_label">招聘对象</td>
					<td class="_cont"><input type="text" name="recruitObject"
						class="form-control" style="background: #F7F8F9;"
						placeholder="招聘对象" id="recruitObject"></td>
				</tr>
				<tr>
					<td class="_label">招聘详情</td>
