...
<body>
	<form action="#" method="get" class="sidebar-form"
		...
		<div class="input-group" style="margin: 0px 25px;padding-top:15px; width: 95%;">
			<table class="search_table">
				<tr>
					<td align="right">
					<a href="${basePath}/investorEduAddInit" class="btn btn-info" title="投资者教育-新增">新增</a>
					</td>
				</tr>
			</table>
			</span>
	...
	<script type="text/javascript">
		...
		function pageInit() {
			jQuery("#table").jqGrid(
					{
						url : '${basePath}/investorEdu',
						method: "GET",
						datatype : "json",
						colNames : ['', '投资者教育', '发布时间', '开放标识',"",""],
						colModel : [ {
							name : 'no',
							index : 'no',
							hidden : true,
						...
						sortable:true,
						sortorder : "desc",
						editurl : "${basePath}/investorEduEdit",
						//后台返回数据
						...
						gridComplete:function(){
							...
							for (var i=0;i<ids.length;i++){
								...
								modify = "<a href='${basePath}/investorEdu/"+model.no+"' style='color:#f60'>修改</a>";
		...
		function Delete(no){
			if(confirm("确定删除吗？")){
				jQuery.ajax({
					...
					url : '${pageContext.request.contextPath}/investorEduDelete?no='+no,
					cache : false,
					async : false,
					dataType : 'json',
