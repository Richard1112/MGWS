...
<body>
	<form:form id="mainForm" name="mainForm"
		action="${basePath}/investorSignEdit" method="post"
		commandName="tInvestorSign" modelAttribute="tInvestorSign">
			...
			<table class="editTable">
				<tr>
					<td colspan="2" align="left"><a href="javascript:void(0)"
						...
						href="${pageContext.request.contextPath}/investorSignInit"
...
<myfooter>
	...
	var saveImgUrl = "${saveInvestorPDFUrl}";
	var investorSignNo = $("#no").val();
	if ($("#fileName").val() != null && $("#fileName").val() != "") {
		...
		var tjson = {caption: '', // 展示的文件名  
                width: '120px',   
                url: '${basePath}/investorSignDeleteFile', // 删除url  
                key: $("#fileName").val(), // 删除是Ajax向后台传递的参数  
                extra: {fileId: $("#fileName").val(), investorSignNo: investorSignNo} 
            };
		preThumbConfigList.push(tjson);
	}
	$("#fileNameUpdate").fileinput({
        uploadUrl: '${pageContext.request.contextPath}/investorSignUpdateFile?investorSignNo='+investorSignNo,
