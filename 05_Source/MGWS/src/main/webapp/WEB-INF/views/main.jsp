			...
			<div class="main_about_us_info">
				...
				<div class="content_info magin-top-5px">
					...
					<div class="main_jy_content magin-top-20px">
						公司成立以来，采用国际领先的交易方法，通过杠杆化，严格的风险控制以及程序化交易等工具的支持，辅以持续不断的IT投入，开发新的交易策略，使公司一直保持卓越的竞争力，并积累了大量宝贵的经验。目前公司在国内市场的日交易量超过1.2亿元人民币，约占中国A股融券市场日交易量的2%。在境外国库券期货价差合约市场以及跨市场套利也保持着业内领先的活跃交易量和稳定客观的收益
					</div>
